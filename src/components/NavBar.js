...
<Nav className="bg-dark w-100">
        <Container className="d-flex bg-dark w-100 align-items-center justify-content-around">
          ...
          <Link className="beauty-spa fs-md-2 fs-sm-5 " to="/main/0">Mel On-line Store</Link>
           ...
           <Link className="btn btn-outline-info btn-sm" to="/main/0">All</Link>
              <Link className="btn btn-outline-warning btn-sm" to="/main/0">Ir al Carrito</Link>
