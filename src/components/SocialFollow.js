...
export default function SocialFollow() {
  return (
    <div className="social-container">
      <a
        href="https://www.youtube.com/c/@tvracinternacional3928"
        className="youtube social "
      >
        <FontAwesomeIcon icon={faYoutube} size="2x" color="aliceblue" />
      </a>
      <a href="https://www.facebook.com/tvrac.net/" className="facebook social">
      ...
      <a
        href="https://www.instagram.com/tvracinternacional"
